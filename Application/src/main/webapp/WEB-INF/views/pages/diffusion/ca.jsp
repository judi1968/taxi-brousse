        ...
        <div class="main-panel">
          <div class="content-wrapper">
           ...
           <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="caPublicite" method="get">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            <label for="nombrePub" class="col-sm-3 col-form-label">Date debut</label>
                            <div class="col-sm-9">
                              <input type="datetime-local" class="form-control" id="nombrePub" name="nombrePub" >
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="nombrePub" class="col-sm-3 col-form-label">Date fin</label>
                            <div class="col-sm-9">
                              <input type="datetime-local" class="form-control" id="nombrePub" name="nombrePub" >
                            </div>
                          </div>
            ...
            <%= (String) request.getAttribute("caTab")  %>
          </div>
