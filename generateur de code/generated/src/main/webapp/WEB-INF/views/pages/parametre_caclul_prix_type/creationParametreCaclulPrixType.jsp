                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="reference_type_client" name="reference_type_client" required>
...
<% }
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="object_type_client" name="object_type_client" required>
...
<% }
                      ...
                      <a href="/parametre_caclul_prix_type" class="btn btn-dark">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
