...
<% }
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="place" name="placeId" required>
...
%>
                                <option value="<%= place_voiture.getId() %>"> 
                                  ...
                                  <%= place_voiture.getNom() != null ? place_voiture.getNom() : "ID: " + place_voiture.getId() %>
                                </option>
<% }
                                } %>
                              </select>
...
<% }
                      ...
                      <a href="listeTypePlaceVoyage" class="btn btn-dark">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
