                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="voiture" name="voiture" required>
...
<% }
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="voyage" name="voyage" required>
...
<% }
                      ...
                      <a href="/voyage_voiture" class="btn btn-dark">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
