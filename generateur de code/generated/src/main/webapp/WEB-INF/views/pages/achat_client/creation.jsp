...
<% }
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" id="type_place_voyage" name="type_place_voyageId" required>
...
%>
                                <option value="<%= type_place_voyage.getId() %>"> 
                                  ...
                                  <%= type_place_voyage.getNom() != null ? type_place_voyage.getNom() : "ID: " + type_place_voyage.getId() %>
                                </option>
<% }
                                } %>
                              </select>
                      ...
                      <a href="listeAchatClient" class="btn btn-dark">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
