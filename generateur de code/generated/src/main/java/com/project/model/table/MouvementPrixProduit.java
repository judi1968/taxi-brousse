...
@TableDb(name = "mouvement_prix_produit")
public class MouvementPrixProduit {
    ...
    public MouvementPrixProduit() {
    }

    public MouvementPrixProduit(int id, Produit produit, Double montant, Date dateMouvement) {
        this.id = id;
